...
> [!NOTE]
> O SCC atualmente é um MVP em constante validação e evolução. Serei imensamente grato se quiser ajudar no desenvolvimento do MVP com comentários construtivos e direcionais. Por favor, mantenha a educação e o decoro. Os comentários podem ser feitos no final desta página na área de comentários. Grato pela sua compreensão e apoio.
...
Passo a passo completo, reprodutível e auditável (você compila o próprio kernel a partir da fonte oficial da Microsoft — nunca baixe um binário de kernel pronto de terceiros, é risco de segurança real, não excesso de cautela): consulte o guia em **[docs/WSL_BPF_LSM_Decision.md](https://github.com/rodrigoffreir3/syscallcage/blob/main/docs/WSL_BPF_LSM_Decision.md)**.
