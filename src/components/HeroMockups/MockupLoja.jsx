...
/**
 * MockupLoja — SPEC-SITE-007 RF-1 (Mockup 1)
 * Loja virtual com fluxo de vitrine, produtos e checkout seguro.
 */
export default function MockupLoja({ isActive = true }) {
  const animClass = isActive ? 'anim-active' : '';

  return (
    <div className={`hero-mockup-window mockup-type-store ${animClass}`} aria-hidden="true">
