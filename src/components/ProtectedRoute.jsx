...
export default function ProtectedRoute({ children }) {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: 'var(--bg-page)', color: 'var(--color-brand-ink)', fontFamily: 'var(--font-heading)' }}>
